...
type SpaceVariable<K extends string, V extends number | string, U extends string> = `var(${K}, ${V}${U})`

export class Space<
    K extends string,
    V extends number | string,
    U extends string
> implements ICSSDeclaration<K, V, SpaceDeclaration<K, V, U>, SpaceVariable<K, V, U>> {
