...
export abstract class Easing {
    ...
    public static readonly Array = class {
        public static readonly Standard                 = [0.20, 0.00, 0.0, 1.00]
        public static readonly StandardAccelerate       = [0.30, 0.00, 1.0, 1.00]
        public static readonly StandardDecelerate       = [0.00, 0.00, 0.0, 1.00]
        public static readonly Emphasized               = [0.20, 0.00, 0.0, 1.00]
        public static readonly EmphasizedAccelerate     = [0.30, 0.00, 0.8, 0.15]
        public static readonly EmphasizedDecelerate     = [0.05, 0.70, 0.1, 1.00]
        public static readonly Legacy                   = [0.40, 0.00, 0.2, 1.00]
        public static readonly LegacyAccelerate         = [0.40, 0.00, 1.0, 1.00]
        public static readonly LegacyDecelerate         = [0.00, 0.00, 0.2, 1.00]
        public static readonly Linear                   = [0.00, 0.00, 1.0, 1.00]
        public static readonly ExpressiveFastSpatial    = [0.42, 1.67, 0.21, 0.90]
        public static readonly ExpressiveDefaultSpatial = [0.38, 1.21, 0.22, 1.00]
        public static readonly ExpressiveSlowSpatial    = [0.39, 1.29, 0.35, 0.98]
        public static readonly ExpressiveFastEffects    = [0.31, 0.94, 0.34, 1.00]
        public static readonly ExpressiveDefaultEffects = [0.34, 0.80, 0.34, 1.00]
        public static readonly ExpressiveSlowEffects    = [0.34, 0.88, 0.34, 1.00]
        public static readonly StandardFastSpatial      = [0.27, 1.06, 0.18, 1.00]
        public static readonly StandardDefaultSpatial   = [0.27, 1.06, 0.18, 1.00]
        public static readonly StandardSlowSpatial      = [0.27, 1.06, 0.18, 1.00]
        public static readonly StandardFastEffects      = [0.31, 0.94, 0.34, 1.00]
        public static readonly StandardDefaultEffects   = [0.34, 0.80, 0.34, 1.00]
        public static readonly StandardSlowEffects      = [0.34, 0.88, 0.34, 1.00]
    }
}
